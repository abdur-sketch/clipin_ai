...
type Clip = {
  ...
  aspectRatio?: string; fontSize?: number; watermark?: boolean; logoName?: string; postCaption?:string;postCta?:string;postHashtags?:string[];
};
